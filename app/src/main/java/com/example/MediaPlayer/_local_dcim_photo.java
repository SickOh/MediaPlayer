...
public class _local_dcim_photo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            progressDialog = new TextView(_local_dcim_photo.this);
            alertDialogBuilder = new AlertDialog.Builder(_local_dcim_photo.this);
            ...
            lv_adapter = new ArrayAdapter<>(_local_dcim_photo.this,
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(final AdapterView<?> parent, View v,
                ...
                index = position;
                inflater = (LayoutInflater) _local_dcim_photo.this.getSystemService(LAYOUT_INFLATER_SERVICE);

                layout = inflater.inflate(R.layout.popup_image,null);
                layout.findViewById(R.id.layout_root);
                btn_rotate = layout.findViewById(R.id.BTN_ROTATE);
                LL_Photo.addView(layout);
                Toast.makeText(_local_dcim_photo.this, "Slide Down to Close", Toast.LENGTH_LONG).show();
                RefreshGridView();
        ...
        alertDialogBuilder.setNegativeButton("STOP", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try{
                    ...
                    Log.d("EXCEPTION: ", "_local_dcim_photo.dialogBox");
                }
    ...
    public void setImages(final String imagePath){
        ...
        adapter = new CustomGrid(_local_dcim_photo.this, web, "DCIM");
    ...
    private boolean setImages(int mIndex){
        ...
        if(mIndex > 0){
            Glide.with(_local_dcim_photo.this)
    ...
    private void RefreshGridView(){
        ...
        mImage = new ImageView(_local_dcim_photo.this);
        mImage2 = new ImageView(_local_dcim_photo.this);
        mImage3 = new ImageView(_local_dcim_photo.this);
        ...
        btn_rotate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Log.d("EXCEPTION: ", "_local_dcim_photo.RefreshGridView: " + e.toString());
                }
            }
        });
    ...
    public static Integer GetCheckId(int position){
